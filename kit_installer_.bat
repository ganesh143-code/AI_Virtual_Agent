...
SET REPO_DOWNLOAD_URL=https://github.com/kandi1clickkits/faq-virtual-agent/releases/download/v1.0.0/faq-virtual-agent.zip
...
IF /I "%CONFIRM%" NEQ "Y" (
	...
	ECHO==========================================================================
	tar -xvf %REPO_NAME%
	REM jupyter notebook "%EXTRACTED_REPO_DIR%\%NOTEBOOK_NAME2%"
